        ...
        try:
            ...
            while len(self.posts_data) < self.tweets_count:
                for tweet in present_tweets:
                    ...
                    retweet_link = Finder._Finder__find_all_anchor_tags(tweet)[2].get_attribute(
                        "href") if is_retweet is True else ""
...
def json_to_csv(filename, json_data, directory):
    ...
    fieldnames = ['username', 'is_retweet', 'content', 'tweet_url']
...
def scrap_profile(twitter_username, browser="firefox", proxy=None, tweets_count=10, output_format="json", filename="",
                  directory=os.getcwd()):
    """
